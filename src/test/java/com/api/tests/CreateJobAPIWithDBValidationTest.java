...
public class CreateJobAPIWithDBValidationTest {
	...
	public void setup() {
		...
		customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "13235812527814","13235812527814", "13235812527814", getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(), Model.NEXUS_2_BLUE.getCode());
